...
const TechStack = () => {
  ...
  return (
    ...
    >
      ...
      <img className="ts-accent ts-accent--1" src="/assets/premium/fig3.png" alt="" aria-hidden="true" />
      <img className="ts-accent ts-accent--2" src="/assets/premium/space-rocket.png" alt="" aria-hidden="true" />

      <div className="container ts-inner">
        <header className="ts-head">
          <p className="eyebrow reveal reveal-up">{sectionCopy.stack.eyebrow}</p>
          <h2 className="section-title reveal reveal-up">{sectionCopy.stack.title}</h2>
        </header>
        ...
        <div className="ts-grid reveal-stagger" aria-label="Tech stack">
          {allItems.map((item, i) => {
            ...
            return (
              <div className="ts-item reveal reveal-scale" style={{ '--reveal-i': i }} key={item}>
