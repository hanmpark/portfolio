...
export const hero = {
  ...
  lede:
    'I help teams launch thoughtful digital products by blending crisp strategy, human-centered design, and frontend direction. Based in Seoul, partnering globally.',
...
export const sectionCopy = {
  ...
  services: {
    ...
    subtitle: 'Flexible engagements designed to plug into your team and unlock momentum.',
  },
  about: {
    eyebrow: 'About',
...
export const aboutNote = {
  eyebrow: 'Currently',
  text:
    'Building a calm dashboard language for data-heavy SaaS teams with distributed users.',
}
